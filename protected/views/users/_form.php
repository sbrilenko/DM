...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'confirm_url'); ?>
		<?php echo $form->textField($model,'confirm_url',array('size'=>60,'maxlength'=>512)); ?>
		<?php echo $form->error($model,'confirm_url'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'confirm_time'); ?>
		<?php echo $form->textField($model,'confirm_time'); ?>
		<?php echo $form->error($model,'confirm_time'); ?>
	</div>
